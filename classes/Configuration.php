...
class DpdGroupConfiguration extends DpdGroupObjectModel
{
	const DEBUG_MODE	 							= 'DPD_GROUP_DEBUG_MODE';
	const PRODUCTION_MODE 							= 'DPD_GROUP_PRODUCTION_MODE';
	const ADDRESS_VALIDATION 						= 'DPD_GROUP_ADDRESS_VALIDATION';
	const SERVICE_CLASSIC 							= 'DPD_GROUP_SERVICE_CLASSIC';
	const SERVICE_10 								= 'DPD_GROUP_SERVICE_10';
	const SERVICE_12 								= 'DPD_GROUP_SERVICE_12';
	const SERVICE_SAME_DAY 							= 'DPD_GROUP_SERVICE_SAME_DAY';
	const SERVICE_B2C 								= 'DPD_GROUP_SERVICE_B2C';
	const SERVICE_INTERNATIONAL						= 'DPD_GROUP_SERVICE_INTERNATION';
	const SERVICE_BULGARIA							= 'DPD_GROUP_SERVICE_BULGARIA';
	const PACKING_METHOD 							= 'DPD_GROUP_PACKING_METHOD';
	const COUNTRY 									= 'DPD_GROUP_COUNTRY';
	const PRODUCTION_URL 							= 'DPD_GROUP_PRODUCTION_URL';
	const TEST_URL 									= 'DPD_GROUP_TEST_URL';
	const USERNAME 									= 'DPD_GROUP_USERNAME';
	const PASSWORD 									= 'DPD_GROUP_PASSWORD';
	const TIMEOUT 									= 'DPD_GROUP_TIMEOUT';
	const SENDER_ID 								= 'DPD_GROUP_SENDER_ID';
	const PAYER_ID 									= 'DPD_GROUP_PAYER_ID';
	const WEIGHT_CONVERSATION_RATE					= 'DPD_GROUP_WEIGHT_RATE';
	const PRICE_CALCULATION							= 'DPD_GROUP_PRICE_CALCULATION';

	const CARRIER_CLASSIC_ID						= 'DPD_GROUP_CARRIER_CLASSIC_ID';
	const CARRIER_10_ID								= 'DPD_GROUP_CARRIER_10_ID';
	const CARRIER_12_ID								= 'DPD_GROUP_CARRIER_12_ID';
	const CARRIER_SAME_DAY_ID						= 'DPD_GROUP_CARRIER_SAME_DAY_ID';
	const CARRIER_B2C_ID							= 'DPD_GROUP_CARRIER_B2C_ID';
	const CARRIER_INTERNATIONAL_ID					= 'DPD_GROUP_CARRIER_INTERNAT_ID';
	const CARRIER_BULGARIA_ID						= 'DPD_GROUP_CARRIER_BULGARIA_ID';

	const CARRIER_CLASSIC_COD_ID					= 'DPD_GROUP_COD_CLASSIC_ID';
	const CARRIER_10_COD_ID							= 'DPD_GROUP_COD_10_ID';
	const CARRIER_12_COD_ID							= 'DPD_GROUP_COD_12_ID';
	const CARRIER_SAME_DAY_COD_ID					= 'DPD_GROUP_COD_SAME_DAY_ID';
	const CARRIER_B2C_COD_ID						= 'DPD_GROUP_COD_B2C_ID';
	const CARRIER_INTERNATIONAL_COD_ID				= 'DPD_GROUP_COD_INTERNATIONAL_ID';
	const CARRIER_BULGARIA_COD_ID					= 'DPD_GROUP_COD_BULGARIA_ID';

	const IS_COD_CARRIER_CLASSIC					= 'DPD_GROUP_IS_COD_CLASSIC';
	const IS_COD_CARRIER_10							= 'DPD_GROUP_IS_COD_10';
	const IS_COD_CARRIER_12							= 'DPD_GROUP_IS_COD_12';
	const IS_COD_CARRIER_SAME_DAY					= 'DPD_GROUP_IS_COD_SAME_DAY';
	const IS_COD_CARRIER_B2C						= 'DPD_GROUP_IS_COD_B2C';
	const IS_COD_CARRIER_INTERNATIONAL				= 'DPD_GROUP_IS_COD_INTERNATIONAL';
	const IS_COD_CARRIER_BULGARIA					= 'DPD_GROUP_IS_COD_BULGARIA';
	...
	const COD_MODULE								= 'DPD_GROUP_COD_MODULE';

	const COD_PERCENTAGE_CALCULATION				= 'DPD_GROUP_COD_CALCULATION';
	const COD_PERCENTAGE_CALCULATION_CART			= 'DPD_GROUP_CALCULATION_CART';
	const COD_PERCENTAGE_CALCULATION_CART_SHIPPING	= 'DPD_GROUP_CALCULATION_SHIPPING';
